...
export function QuizResponseDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuizResponseDto {
    ...
    return {
        ...
        'questions': json['questions'] == null ? undefined : ((json['questions'] as Array<any>).map(QuestionResponseDtoFromJSON)),
...
export function QuizResponseDtoToJSON(value?: QuizResponseDto | null): any {
    ...
    return {
        ...
        'questions': value['questions'] == null ? undefined : ((value['questions'] as Array<any>).map(QuestionResponseDtoToJSON)),
        'id': value['id'],
