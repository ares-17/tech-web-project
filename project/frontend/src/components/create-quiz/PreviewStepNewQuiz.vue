<template>
      <div>
        <h2 class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-12 mb-3 mx-auto text-center">{{ $t('createquiz_title_preview') }}</h2>
        ...
        <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-12 mb-3 pt-3 mx-auto d-flex justify-content-between">
            <button type="button" class="btn btn-outline-secondary" @click="$emit('prev')">{{$t('question_component_back')}}</button>
            <button type="button" class="btn btn-primary" @click="createQuiz">{{$t('createquiz_submitquiz')}}</button>
        </div>
        <!--
