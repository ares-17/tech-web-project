                    ...
                    <v-form readonly>
                        <div class="row">
                            <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-6 mb-2 h-100">
                                <v-text-field v-model="quizDetails!.numQuestions"
                                    :label="$t('quiz_istance_num_questions')"></v-text-field>
                            </div>
                            <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-6 mb-2 h-100">
                                <v-text-field v-model="quizDetails!.maxErrors"
                                    :label="$t('quiz_istance_errors')"></v-text-field>
                            </div>
                            <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-6 mb-2 h-100">
                                <v-text-field v-model="quizDetails!.createdBy"
                                    :label="$t('quiz_istance_num_created_by')"></v-text-field>
                            </div>
                            <div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-6 mb-2 h-100">
                                <v-text-field v-model="quizDetails!.createdAt"
                                    :label="$t('quiz_istance_created_at')"></v-text-field>
                            </div>
                        </div>
                    </v-form>
                    <div>
                        <v-divider></v-divider>
                        <h4 class="align-items-center d-flex my-4"><v-icon icon="mdi-account"></v-icon> Punteggi
                            ottenuti</h4>
