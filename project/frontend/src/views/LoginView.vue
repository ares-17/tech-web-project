            ...
            <v-card class="p-4 main-dialog-card" elevation="16">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 col-sm-12">
                        <v-img width="auto" height="auto" lazy-src="/4957136_4957136.jpg" src="/4957136_4957136.jpg">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 col-sm-12 my-auto p-4">
                        ...
                        <form @submit.prevent="onComplete">
                            <v-text-field v-model="email" density="compact" placeholder="myBeatifulMail@gmail.com"
                                label="Email" prepend-inner-icon="mdi-email-outline" variant="outlined" class="my-3"
                                required :rules="[emailValidation]"></v-text-field>

                            <v-text-field v-model="pwd" :append-inner-icon="isPwdVisibile ? 'mdi-eye-off' : 'mdi-eye'"
                                label="Password" :type="isPwdVisibile ? 'text' : 'password'" density="compact"
                                placeholder="WhatAStrongPwd!" prepend-inner-icon="mdi-lock-outline" variant="outlined"
                                @click:append-inner="isPwdVisibile = !isPwdVisibile" required
                                :rules="[pwdValidation]"></v-text-field>
                            <v-divider class="my-2"></v-divider>
                            <v-card-actions>
                                <v-btn color="primary" :text="$t('create_quiz_dialog_ok_btn')" class="mx-auto" block
                                    type="submit" variant="flat"></v-btn>
                            </v-card-actions>
                        </form>
                    </div>
                </div>
